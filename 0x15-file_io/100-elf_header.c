 ...
 * @e_ident: Pointer to array contain the ELF magical numbers.
 *
 * Description: Magical numbers are separating by space.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: Pointer toarray contain ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * ELF header at beginning of ELF file.
 * @argc: Argument number supply into the program.
 * @argv: array pointers to the argument.
 *
 * Return: on success 0.
 *
 * Description: If the file isn’t ELF File or
 * function failiure - exit code 98.
 */
